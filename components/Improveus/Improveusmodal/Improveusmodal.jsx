      ...
      <div className={styles.modalblock}>
        <div className={styles.modalcontent}>
          ...
          <div className={styles.modalnameemail}>
            <input value={name} onChange={el => setName(el.target.value)} className={styles.modalname} placeholder={t('name')} id="name" autoComplete="name" />
            <input value={email} onChange={ele => setEmail(ele.target.value)} className={styles.modalemail} pattern="[^@\s]+@[^@\s]+\.[^@\s]+" placeholder="Email" id="email" autoComplete="email" />
          </div>
          <textarea value={short_description} onChange={e => setText(e.target.value)} className={styles.modaldescription} placeholder={t('shortdescription')} id="description" autoComplete="description"/>
